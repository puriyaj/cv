      ...
      <div className="grid md:grid-cols-4 grid-cols-3 gap-7 ">
        <div className="rounded-lg border-2 flex flex-col justify-center items-center">
          <Image
            ...
            height={100}
          />
          <h1 className="font-roboto text-2xl text-justify text-gray-700 dark:text-gray-50">
            Java script
          </h1>
          <p className="font-roboto text-sm text-justify p-2 text-gray-700 dark:text-gray-50">
        ...
        <div className="rounded-lg border-2 flex flex-col justify-center items-center ">
          <Image
            className="rounded-full p-5"
            src="/images/icons/tensorflow.webp"
            alt="java script"
            width={100}
            height={100}
          />
        ...
        <div className="rounded-lg border-2 flex flex-col justify-center items-center">
          <Image
            className="rounded-full p-5"
            src="/images/icons/tailwindcss.webp"
            alt="java script"
            width={100}
            height={100}
          />
        ...
        <div className="rounded-lg border-2 flex flex-col justify-center items-center">
          <Image
            className="rounded-full p-5"
            src="/images/icons/google-colab.webp"
            alt="java script"
            width={100}
            height={100}
          />
